      ...
      <nav className="relative z-20 flex items-center px-6 lg:px-10 py-5">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <button onClick={() => navigate("/history")} className="flex items-center gap-1.5 h-9 px-4 rounded-full border border-border/40 bg-secondary/60 text-sm font-medium text-foreground hover:bg-primary/15 hover:border-primary/40 hover:scale-105 transition-all duration-200">
